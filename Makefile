...
precompiler: pre/precompiler.go runtime/runtime.go $(tmp)
...
./tmp/precompiler_test: precompiler t/test.go
	...
	as -o $(tmp)/precompiler_test.o $(tmp)/precompiler_test.s runtime/runtime.s
...
babygo: main.go runtime/runtime.go runtime/runtime.s precompiler
	./precompiler < main.go > $(tmp)/babygo.s
	cp $(tmp)/babygo.s ./tmp/ # for debug
	as -o $(tmp)/babygo.o $(tmp)/babygo.s runtime/runtime.s
...
test1:	babygo t/test.go
	...
	as -o $(tmp)/test.o $(tmp)/test.s runtime/runtime.s
...
babygo2: babygo
	...
	as -o $(tmp)/2gen.o $(tmp)/2gen.s runtime/runtime.s
...
test2: babygo2
	...
	as -o $(tmp)/test2.o $(tmp)/test2.s runtime/runtime.s
...
test-self-host: $(tmp)
	...
	as -o $(tmp)/bbg2.o $(tmp)/bbg2.s runtime/runtime.s
